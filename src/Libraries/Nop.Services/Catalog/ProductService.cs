...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        private const string TIERPRICECATEGORY_ALL_KEY = "Nop.tierpricecategories.all";//CUSTOM
        #endregion
        ...
        private readonly IRepository<TierPriceCategory> _tierPriceCategoryRepository;//CUSTOM
        ...
        public ProductService(ICacheManager cacheManager,
            ...
            IRepository<TierPriceCategory> tierPriceCategoryRepository,//CUSTOM
            ...
            IStoreMappingService storeMappingService)
        {
            ...
            this._tierPriceCategoryRepository = tierPriceCategoryRepository;//CUSTOM
        ...
        #region Tier price categories
        //CUSTOM - Start
        /// <summary>
        /// Gets all stores
        /// </summary>
        /// <returns>Stores</returns>
        public virtual IList<TierPriceCategory> GetAllPriceTierCategories()
        {
            string key = TIERPRICECATEGORY_ALL_KEY;
            return _cacheManager.Get(key, () =>
            {
                var query = from s in _tierPriceCategoryRepository.Table
                            orderby s.Id
                            select s;
